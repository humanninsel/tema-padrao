...
gulp.task("browser-sync", function () {
  browserSync.init({
    proxy: "localhost/baronconstrutora/",
  });
});
...
/* Watch */
gulp
  .watch("./source/sass/**/*.scss", gulp.series("clear", "sass"))
  .on("change", browserSync.reload);
gulp
  .watch("./source/js/**/*.js", gulp.series("clear", "js"))
  .on("change", browserSync.reload);
gulp
  .watch("./source/php/**/**", gulp.series("clear", "html"))
  .on("change", browserSync.reload);
...
gulp.task(
  "default",
  gulp.parallel("sass", "html", "js", "browser-sync")
);
